                ...
                <tbody class="bg-white">
                    @foreach ($posts as $post)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <img src="{{ $post->image }}" class="max-h-[150px]">
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-900">
                                    {{ implode(' ', array_slice(explode(' ', strip_tags($post->excerpt)), 0, 5)) }}
                                </div>
                            </td>
                            ...
                            <td
                                class="px-6 py-4 flex gap-2 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                <a href="/dashboard/posts/{{ $post->slug }}"><svg xmlns="http://www.w3.org/2000/svg"
